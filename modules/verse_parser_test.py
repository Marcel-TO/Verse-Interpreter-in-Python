...
class ParserTest(unittest.TestCase):
    ...
    @data({'input': "(x:=3) + 65", 'expected': OperatorNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value),  BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 3))), NumberNode(Token(TokenTypes.INTEGER, 65)))},
          ...
          {'input': "x:int + 4", 'expected': OperatorNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value),  ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))), NumberNode(Token(TokenTypes.INTEGER, 4)))},
          ...
          {'input': "x:int - 4", 'expected': OperatorNode(Token(TokenTypes.MINUS, TokenTypes.MINUS.value),  ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))), NumberNode(Token(TokenTypes.INTEGER, 4)))},
          ...
          {'input': "x:int * 4", 'expected': OperatorNode(Token(TokenTypes.MULTIPLY, TokenTypes.MULTIPLY.value),  ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))), NumberNode(Token(TokenTypes.INTEGER, 4)))},
          ...
          {'input': "x:int < 4", 'expected': OperatorNode(Token(TokenTypes.LOWER, TokenTypes.LOWER.value),  ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))), NumberNode(Token(TokenTypes.INTEGER, 4)))},
          ...
          {'input': "x:int > 4", 'expected': OperatorNode(Token(TokenTypes.GREATER, TokenTypes.GREATER.value),  ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))), NumberNode(Token(TokenTypes.INTEGER, 4)))},
    ...
    @data({'input': "65 + x:=3", 'expected': OperatorNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value), NumberNode(Token(TokenTypes.INTEGER, 65)),  BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          ...
          {'input': "4 + x:int", 'expected': OperatorNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value), NumberNode(Token(TokenTypes.INTEGER, 4)),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
          ...
          {'input': "4 - x:int", 'expected': OperatorNode(Token(TokenTypes.MINUS, TokenTypes.MINUS.value), NumberNode(Token(TokenTypes.INTEGER, 4)),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
          ...
          {'input': "4 * x:int", 'expected': OperatorNode(Token(TokenTypes.MULTIPLY, TokenTypes.MULTIPLY.value), NumberNode(Token(TokenTypes.INTEGER, 4)),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
          ...
          {'input': "4 < x:int", 'expected': OperatorNode(Token(TokenTypes.LOWER, TokenTypes.LOWER.value), NumberNode(Token(TokenTypes.INTEGER, 4)),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
          ...
          {'input': "4 > x:int", 'expected': OperatorNode(Token(TokenTypes.GREATER, TokenTypes.GREATER.value), NumberNode(Token(TokenTypes.INTEGER, 4)),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
    ...
    @data({'input': "(1;false?)", 'expected': BlockNode([NumberNode(Token(TokenTypes.INTEGER, 1)),FailNode(Token(TokenTypes.FAIL, TokenTypes.FAIL.value))])},
          ...
          {'input': "(x:int;3)", 'expected': BlockNode([ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),NumberNode(Token(TokenTypes.INTEGER, 3))])},
    ...
    @data({'input': "(1|false?)", 'expected': ChoiceSequenceNode(Token(TokenTypes.CHOICE, TokenTypes.CHOICE.value),[NumberNode(Token(TokenTypes.INTEGER, 1)),FailNode(Token(TokenTypes.FAIL, TokenTypes.FAIL.value))])},
          ...
          {'input': "((x:int)|3)", 'expected': ChoiceSequenceNode(Token(TokenTypes.CHOICE, TokenTypes.CHOICE.value),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),NumberNode(Token(TokenTypes.INTEGER, 3))])},
    ...
    @data({'input': "f(false?)", 'expected': FuncCallNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[FailNode(Token(TokenTypes.FAIL, TokenTypes.FAIL.value))])},
          ...
          {'input': "f(x:int)", 'expected': FuncCallNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))])},
    ...
    @data({'input': "f():= 2", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,None,NumberNode(Token(TokenTypes.INTEGER, 2)))},
          ...
          {'input': "f():= x:int", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,None,ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
    ...
    @data({'input': "f(x:int, y:int):= 2", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,NumberNode(Token(TokenTypes.INTEGER, 2)))},
          {'input': "f(x:int, y:int):= 7 + 3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,OperatorNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value), NumberNode(Token(TokenTypes.INTEGER, 7)), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f(x:int, y:int):= x:=3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f(x:int, y:int):= if(1) then 2 else 3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,IfNode(Token(TokenTypes.IF, TokenTypes.IF.value), NumberNode(Token(TokenTypes.INTEGER, 1)), NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f(x:int, y:int):= (2,2)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,SequenceNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f(x:int, y:int):= (2|2)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,ChoiceSequenceNode(Token(TokenTypes.CHOICE, TokenTypes.CHOICE.value),[NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f(x:int, y:int):= (x:=2; x)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,BlockNode([ BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 2))), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f(x:int, y:int):= x:int", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
          {'input': "f(x:int, y:int):= false?", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,None,FailNode(Token(TokenTypes.FAIL, TokenTypes.FAIL.value)))})
    @unpack
    ...
    @data({'input': "f():int := 2", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),NumberNode(Token(TokenTypes.INTEGER, 2)))},
          {'input': "f():int := 7 + 3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),OperatorNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value), NumberNode(Token(TokenTypes.INTEGER, 7)), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f():int := x:=3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f():int := if(1) then 2 else 3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),IfNode(Token(TokenTypes.IF, TokenTypes.IF.value), NumberNode(Token(TokenTypes.INTEGER, 1)), NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f():int := (2,2)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),SequenceNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f():int := (2|2)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),ChoiceSequenceNode(Token(TokenTypes.CHOICE, TokenTypes.CHOICE.value),[NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f():int := (x:=2; x)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),BlockNode([ BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 2))), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f():int := x:int", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
          {'input': "f():int := false?", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),FailNode(Token(TokenTypes.FAIL, TokenTypes.FAIL.value)))})
    @unpack
    ...
    @data({'input': "f(x:int, y:int):int := 2", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),NumberNode(Token(TokenTypes.INTEGER, 2)))},
          {'input': "f(x:int, y:int):int := 7 + 3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),OperatorNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value), NumberNode(Token(TokenTypes.INTEGER, 7)), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f(x:int, y:int):int := x:=3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f(x:int, y:int):int := if(1) then 2 else 3", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),IfNode(Token(TokenTypes.IF, TokenTypes.IF.value), NumberNode(Token(TokenTypes.INTEGER, 1)), NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          {'input': "f(x:int, y:int):int := (2,2)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),SequenceNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f(x:int, y:int):int := (2|2)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),ChoiceSequenceNode(Token(TokenTypes.CHOICE, TokenTypes.CHOICE.value),[NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f(x:int, y:int):int := (x:=2; x)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),BlockNode([ BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 2))), NumberNode(Token(TokenTypes.INTEGER, 2))]))},
          {'input': "f(x:int, y:int):int := x:int", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
          {'input': "f(x:int, y:int):int := false?", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))],False,TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),FailNode(Token(TokenTypes.FAIL, TokenTypes.FAIL.value)))})
    ...
    @data({'input': "f:=(x:int=>x+1)", 'expected': FuncDeclNode(IdentifierNode(Token(TokenTypes.IDENTIFIER,"f")),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))], True,None,OperatorNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 1))))})
    @unpack
    ...
    @data({'input': "if (x:int) then y:int else z:int", 'expected': IfNode(Token(TokenTypes.IF, TokenTypes.IF.value),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "z"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
          {'input': "if (x:int) then { y:int } else { z:int }", 'expected': IfNode(Token(TokenTypes.IF, TokenTypes.IF.value),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "z"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
    ...
    @data({'input': "x:int", 'expected': ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))},
          ...
          {'input': "x:tuple(int)", 'expected': ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], SequenceTypeNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))]))},
          {'input': "x:tuple(int,tuple(int))", 'expected': ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], SequenceTypeNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),SequenceTypeNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))])]))})
    @unpack
    ...
    @data({'input': "x,y:int", 'expected': ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")),IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)))},
          ...
          {'input': "x,y:tuple(int)", 'expected': ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")),IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], SequenceTypeNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))]))},
          {'input': "x,y:tuple(int,tuple(int))", 'expected': ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")),IdentifierNode(Token(TokenTypes.IDENTIFIER, "y"))], SequenceTypeNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value)),SequenceTypeNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))])]))})
    @unpack
    ...
    @data({'input': "(1,false?)", 'expected': SequenceNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[NumberNode(Token(TokenTypes.INTEGER, 1)),FailNode(Token(TokenTypes.FAIL, TokenTypes.FAIL.value))])},
          ...
          {'input': "((x:int),3)", 'expected': SequenceNode(Token(TokenTypes.TUPLE_TYPE, TokenTypes.TUPLE_TYPE.value),[ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))),NumberNode(Token(TokenTypes.INTEGER, 3))])},
    ...
    @data({'input': "+ if(1) then 2 else 3", 'expected': UnaryNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value), IfNode(Token(TokenTypes.IF, TokenTypes.IF.value), NumberNode(Token(TokenTypes.INTEGER, 1)), NumberNode(Token(TokenTypes.INTEGER, 2)), NumberNode(Token(TokenTypes.INTEGER, 3))))},
          ...
          {'input': "+ x:int", 'expected': UnaryNode(Token(TokenTypes.PLUS, TokenTypes.PLUS.value), ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))},
    ...
    @data({'input': "x:= 3", 'expected': BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "x")), NumberNode(Token(TokenTypes.INTEGER, 3)))},
          ...
          {'input': "z:= x:int", 'expected': BindingNode(Token(TokenTypes.BINDING, TokenTypes.BINDING.value), IdentifierNode(Token(TokenTypes.IDENTIFIER, "z")), ScopeNode(Token(TokenTypes.SCOPE, TokenTypes.SCOPE.value), [IdentifierNode(Token(TokenTypes.IDENTIFIER, "x"))], TypeNode(Token(TokenTypes.INT_TYPE, TokenTypes.INT_TYPE.value))))})
    @unpack
